        ...
        <div className='mb-8'>
          ...
          <div className='mb-8 hidden sm:block'>
            <div className='mb-4 flex items-center justify-between sm:mb-6'>
              ...
              <button
                className='flex cursor-pointer items-center gap-1 rounded-full bg-[#E30613] px-4 py-1.5 text-sm font-bold text-white shadow transition hover:bg-red-700 sm:gap-2 sm:px-8 sm:py-2 sm:text-lg'
                onClick={() =>
                  handleHashtagClick('/products?category=all-categories')
                }
              >
            ...
            <div className='mx-auto grid max-w-6xl grid-cols-4 gap-3 sm:grid-cols-2 sm:gap-6 md:grid-cols-4 lg:grid-cols-8'>
              {categories.map((cat) => (
                <div
                  key={cat.name}
                  className='flex h-16 min-h-[64px] w-16 min-w-[64px] cursor-pointer flex-col items-center justify-center rounded-2xl bg-white shadow transition-all duration-300 hover:scale-105 hover:shadow-lg sm:h-28 sm:min-h-[96px] sm:w-28 sm:min-w-[96px]'
