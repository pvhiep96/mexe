      ...
      <div className='mt-6'>
        ...
        <div className='mt-6 grid grid-cols-2 gap-3'>
          <button
            ...
            className='flex items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors'
          >
