    ...
    <form onSubmit={handleSubmit} className='space-y-6'>
      <div>
        ...
        <input
          ...
          className={`w-full rounded-lg border px-4 py-3 focus:ring-1 focus:outline-none ${
            errors.email
      ...
      <button
        type='submit'
        disabled={isLoading}
        className='w-full rounded-lg bg-[#2D6294] px-4 py-3 font-medium text-white transition-colors hover:bg-[#2D6294]/90 disabled:opacity-50'
        style={{
      ...
      <div className='text-center'>
        ...
        <button
          ...
          className='text-sm font-medium text-[#2D6294] hover:underline'
        >
          Đăng ký ngay
        </button>
      </div>
