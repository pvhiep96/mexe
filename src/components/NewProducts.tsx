...
export default function NewProducts() {
  ...
  const products: Product[] = [
    {
      id: 1,
      title:
        '(WAREHOUSE DEAL) Bàn Làm Việc Thông Minh 9Space LivArt - Nâng Hạ Điện, Sạc Không Dây, Ngăn Kéo Tiện Lợi',
    ...
    },
    {
      id: 2,
      title:
        'Bàn Phím Cơ Gaming GravaStar Mercury V75 Pro Special Edition Neon Graffiti - Switch Từ Tính Gateron Jade',
  ...
  return (
    <div className='bg-gray-300 p-8'>
      <section
        className='relative rounded-[20px] bg-gray-50 bg-gray-600'
        id='home-coll-preorder'
      ...
      >
        ...
        <div className='relative z-10 container mx-auto px-4 pb-10'>
          <div className='text-center'>
            <div className='inline-block rounded'>
              <h2
                className='bg-contain bg-no-repeat p-4 px-35 py-5 text-2xl font-bold text-white md:text-3xl'
                style={{
                  backgroundImage:
                    "url('https://file.hstatic.net/1000269366/file/mask_group_1a09e296d36c4584be9093cb119d98c8.png')",
                }}
              >
        ...
        {tooltip && (
          <div
            id='tooltip-cms'
            className='fixed z-50 max-w-xs rounded bg-white p-4 text-sm shadow-lg'
