...
export default function LoginModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="login-box bg-white rounded-lg p-6 w-full max-w-md">
        {isRecoverPassword ? (
          <div id="recover-password">
            <div className="recover-heading text-center">
              <h2 className="ega-login-title text-2xl font-bold">TÌM MẬT KHẨU</h2>
              <p className="text-gray-600 mt-2">
                Nhập Email đã đăng ký tài khoản tại Vài Thứ Hay <br />
                Hệ thống sẽ gửi mail đến để xác nhận tài khoản của bạn
              </p>
            </div>
            <form acceptCharset="UTF-8" action="/account/recover" method="post" className="mt-4">
              <input type="hidden" name="form_type" value="recover_customer_password" />
              <input type="hidden" name="utf8" value="✓" />
              <input type="hidden" name="__RequestVerificationToken" value="CfDJ8FyFPV59mBtNhmQGz0fYZt8IQK0jXTrqf697Bh17BBkaAaSLh1EOPdGUT7pXLBXDE8Jykl833yT55RUuUfGttSRkuTN72H4W2u7BysBTXUIJIImyRvt_HI21t4TSTQ7YEkQGJwhrWxDVUlv4HVhnRk0" />
              <div className="form-signup text-red-500 mb-4" />
              ...
              <div className="action_account_custommer text-center">
                <div className="action_bottom action-login button dark mb-2">
                  <input
                    className="btn btn-signin bg-blue-500 text-white p-2 rounded w-full hover:bg-blue-600"
                    type="submit"
                    value="Xác nhận"
                  />
                </div>
                <div className="action_bottom action-register button dark">
                  <a href="#" onClick={handleBackToLogin} className="text-blue-500 hover:underline">
                    Trở về
                  </a>
                </div>
              </div>
          ...
          <div id="login" className="login-popup login-box-body">
            <form acceptCharset="UTF-8" action="/account/login" id="customer_login" method="post">
              ...
              <div className="text-center">
                <h2 className="ega-login-title text-2xl font-bold">ĐĂNG NHẬP</h2>
              </div>
              <div className="ega-form-input mb-4">
                <input
        ...
        <span className="social-login-title text-center block text-gray-600 mb-2">Đăng nhập nhanh với tài khoản mạng xã hội</span>
        <div className="social-btn-wrap flex justify-center space-x-4">
          <button id="btn-facebook-login" className="btn btn-fb btn-signin bg-blue-700 text-white p-2 rounded flex items-center">
          ...
          <button id="btn-google-login" className="btn btn-google-plus bg-red-500 text-white p-2 rounded flex items-center">
            <svg className="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 24 24">
